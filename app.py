...
def users_show(user_id):
    ...
    # bio = User.query.get_or_404(user_bio)
    # location = User.query.get_or_404(user_location)
...
def homepage():
    ...
    if g.user:
        ...
        msgs_ive_like = [u.message_id for u in g.user.likes]
        messages = (Message
                    .query
                    .order_by(Message.timestamp.desc())
        ...
        msgs_ive_like =msgs_ive_like, form = form)
